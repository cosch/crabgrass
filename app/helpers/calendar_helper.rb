module CalendarHelper
  def month_link(month_date)
    link_to(month_date.to_s, {:month => month_date.month, :year => month_date.year})
  end
...
def calendar(options = {}, &block)
      ...
      day_names =[ "Sun", "Mon", "Tue", "Wed", "Thr", "Fr", "Sat"]
#      if options[:abbrev]
...
#      end
    ...
    def day_link(text, date, day_action)
      link_to(text, params.merge(:action => day_action, :year => date.year, :month => date.month, :day => date.day), :class => 
'ec-day-link')
    end
